...
for num = 1:1
    ...
    G = load(['E:\AutomatedTracing\TraceProofreading\TraceProofreading\data\L6_1_initial.mat']);
    AM = G.AM;
    r = G.r;
    R = G.R;
    Orig = double(G.Original)/255;
    ...
    % without Marked
%    [AMlbl,r,R,ClustersStr]=GenerateClustersStrW_new(G.Original,AM,r,R,Parameters);
...
%     save(['E:\AutomatedTracing\Data\Traces\L1\',num2str(num),'_L6_',user(numuser,:),'_withALLClusters1_NewFeatures.mat']);
      save('E:\AutomatedTracing\Data\Traces\L1\1_AAA_L6_withALLClusters1_NewFeatures.mat');
end
...
%     D2 = load(['E:\AutomatedTracing\Data\Traces\L1\',num2str(n),'_L6_',user(numuser,:),'_withALLClusters1_NewFeatures.mat']);
    ...
    D1 = load('E:\AutomatedTracing\Data\Traces\L1\1_AAA_L6_withALLClusters1_NewFeatures.mat');
    D2 = D1;
...
%     GG = load(['E:\AutomatedTracing\Data\Traces\L1_org\',num2str(n),'_L6_',user(numuser,:),'.mat']);
    GG = load('E:\AutomatedTracing\TraceProofreading\TraceProofreading\data\L6_1_initial.mat');
...
path = ['E:\AutomatedTraceResults\DataForConnectingTraining\Data_For_AE_BranchScenarios\IMonce_100_scen_NEW_Inv_FEATURES_User=',user(numuser,:),'_AAA.mat'];
