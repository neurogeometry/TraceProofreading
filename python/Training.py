...
for UseIMage in lst_useImage:
    ...
    for ImagetoTest in [1]:
        ...
        for run in [0,1,2]:
            ...
            PltNAme = 'TEMP21_Drop_20_3LAyerHalf81616_kernel555_S1_2_SmUnet1TEST20INV_FEATURES_CONV=' + str(UseConv) + '_LR=' + str(learning_Rate) + '_100_sce_' + str(
            ...
            for i in range(numScenarios[1]):
                ...
                #     print(degree)
                #     rotated_IMs[:,:,:,r] = scipy.ndimage.interpolation.rotate
                #     (IM, degree, mode='nearest', reshape=False)
